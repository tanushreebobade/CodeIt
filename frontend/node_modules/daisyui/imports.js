...
export const base = {rootscrolllock,svg,rootcolor,properties,scrollbar,rootscrollgutter};
export const components = {countdown,dropdown,stat,fieldset,megamenu,button,aura,divider,validator,progress,footer,tab,tooltip,table,avatar,timeline,carousel,drawer,select,skeleton,hero,radialprogress,dock,card,hover3d,textarea,otp,link,list,hovergallery,modal,kbd,loading,alert,diff,swap,navbar,chat,checkbox,mockup,badge,label,fab,toggle,breadcrumbs,rating,mask,calendar,menu,toast,status,input,steps,textrotate,fileinput,stack,range,radio,collapse,filter,indicator};
